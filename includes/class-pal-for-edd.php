...
class Paypal_For_Edd {
    ...
    public function __construct() {
        ...
        add_filter("{$prefix}plugin_action_links_" . PAYPAL_FOR_EDD_PLUGIN_BASE_NAME, array($this, 'pal_for_edd_plugin_action_links'), 10, 4);
    }
    ...
    public function get_version() {
     ...
     public function pal_for_edd_plugin_action_links($actions, $plugin_file, $plugin_data, $context) {
        $custom_actions = array(
            ...
            'docs' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://www.premiumdev.com/product/paypal-for-easy-digital-downloads-edd/', __('Docs', 'donation-button')),
            'support' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/plugin/pal-for-edd', __('Support', 'donation-button')),
            'review' => sprintf('<a href="%s" target="_blank">%s</a>', 'https://wordpress.org/support/view/plugin-reviews/pal-for-edd', __('Write a Review', 'donation-button')),
        );
